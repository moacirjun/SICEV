...
public class ConnectionPostgreSQL {
    ...
    private String nomeDoBanco = "db_SICEV";
    private String usuario = "Moacir";
    private String senha = "MoacirjuN2122";
    
    public ConnectionPostgreSQL(){}
    
    public ConnectionPostgreSQL(String pServidor, String pNomeDoBanco, String pUsuario, String pSenha){
    ...
    public Connection conectar(){
        try {
            ...
            String url = "jdbc:postgresql://" + servidor + porta + "/" + nomeDoBanco;
    ...
    public int insertSQL(String pSQL){
        ...
        try {
            ...
            /**
             * Só retorna o último id inserido se o SQL passdo terminar 
             * com 'RETURNING id'; 
             *
