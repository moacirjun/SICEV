...
public class connectionMySQL {
    ...
    private String nomeDoBanco = "chikilitas";
    private String usuario = "moacirjun";
    private String senha = "juninho2122";
    
    public connectionMySQL(){}
    
    public connectionMySQL(String pServidor, String pNomeDoBanco, String pUsuario, String pSenha){
